# -*- coding: utf-8 -*-
#
# travis_doc documentation build configuration file,
...
project = u'Travis Built Documentation'
...
try:
    import travis_doc
    version = travis_doc.__version__
except ImportError:
    version = 'unknown'
...
htmlhelp_basename = 'travis_docdoc'
...
latex_documents = [
  (master_doc, 'travis_doc.tex',
   u'Travis Built Documentation Documentation',
